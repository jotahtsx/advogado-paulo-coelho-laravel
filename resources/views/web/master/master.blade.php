...
<head>
    ...
    <link
        href="https://fonts.googleapis.com/css2?family=Playfair+Display:wght@400;500;600;700;800;900&family=Poppins:wght@100;300;400;600;700;900&display=swap"
        rel="stylesheet">
        ...
        <div class="l-header__topbar">
            <div class="topbar-inner">
                <div class="topbar-email">
                    <a class="topbar-email-link" href="mailto:atendimento@paulocoelho.com.br"
                        title="atendimento@paulocoelho.com.br">
                        <img src="{{ url(asset('frontend/images/email-icon.svg')) }}"
                            alt="atendimento@paulocoelho.com.br" title="atendimento@paulocoelho.com.br">
            ...
            <div class="navbar-inner">
                <div class="navbar-inner-logo">
                    <a href="{{ route('web.home') }}" title="Advogado Paulo Coelho">
                        <img src="{{ url(asset('frontend/images/logo.svg')) }}"
                            alt="Advogado
              Paulo Coelho" title="Advogado Paulo Coelho">
                    </a>
                </div>
                <nav class="navbar-inner-nav-mobile">
                    <button type="button" aria-label="Abrir Menu" aria-haspopup="true" aria-controls="menu-mobile"
                        aria-expanded="false" class="btn-menu">
                        Menu
                ...
                <nav class="navbar-inner-nav">
                    ...
                    <a href="{{ route('web.contact') }}" class="{{ isActive('web.contact') }}"
                ...
                <nav class="navbar-inner-social">
                    ...
                    <a class="navbar-inner-social-icon" href="" title="Instagram">
                        <img src="{{ url(asset('frontend/images/instagram-icon.svg')) }}" alt=""
                            title="">
                    </a>
