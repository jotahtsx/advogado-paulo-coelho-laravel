        ...
        <div class="l-main__inner">
          ...
          <div class="l-main__items">
            <a href="" title="Direito Triburário" class="item">
              <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-scale" width="44" height="44" viewbox="0 0 24 24" stroke-width="1.5" stroke="#2c3e50" fill="none" stroke-linecap="round" stroke-linejoin="round">
            ...
            <a href="" title="Dívidas Rurais" class="item">
              <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-building-warehouse" width="44" height="44" viewbox="0 0 24 24" stroke-width="1.5" stroke="#2c3e50" fill="none" stroke-linecap="round" stroke-linejoin="round">
                <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
          ...
          <div class="inner">
            ...
            <div class="faq-section section-hide">
              <div class="faq-title" onclick="clickAccordion(0)">
                ...
                <img src="{{url(asset('frontend/images/faq-icon.svg'))}}" alt="" title="" class="faq-icon">
              </div>
              <p class="hide">
